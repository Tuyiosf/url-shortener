...
If you are new to this kind of software, don’t worry. This guide will walk you through every step, from downloading the program to running it on your computer.
...
After downloading and extracting the files from the Releases page:

1. Open your terminal or command prompt.
2. Change the directory to where you extracted the files. For example:

   ```
   cd path/to/url-shortener
   ```

3. Install the needed packages by typing:

   ```
   npm install
   ```

4. When finished, your application will be ready to run.

## 🚀 Running the Application

url-shortener is a backend service. That means it runs on your computer or a server and manages short URLs behind the scenes.

### Starting the service

Still inside the url-shortener folder in your terminal, type:

```
npm start
```

This command will start the application. You should see messages confirming it is running and listening for links.
...
- Go to the local address, usually:

  ```
  http://localhost:3000
  ```

- You will see options for entering a long URL and getting a short one.
- You can also view stats and manage expiry dates for your links.

## 🔧 Features

url-shortener offers these main features:

- **Shorten URLs:** Convert long website addresses into short, easy-to-share links.
...
To run url-shortener smoothly, your system should meet these requirements:

- Operating System: Windows 10+, macOS 10.13+, or Linux.
- Processor: Any modern processor (Intel i3 or better recommended).
- RAM: At least 2 GB free.
- Disk Space: At least 100 MB free to store application files and logs.
- Network: Internet connection for initial setup and link analytics.
...
- **Missing files:** Ensure you extracted all downloaded files correctly.
- **Permission errors:** Run the terminal as Administrator (Windows) or use `sudo` on Linux/macOS when necessary.
...
- Look for common problems and how others fixed them.
- If you do not find an answer, create a new Issue describing your problem clearly.
